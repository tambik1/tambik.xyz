@extends('layouts.app')
@section('content')
       <div class="team_container" style="display: flex;flex-direction: column;align-content: center;align-items: center; height: 85vh">
           <div class="uk-card uk-card-default" style="width: 50%">
